...
public class SignupTeacher extends AppCompatActivity {
    ...
    EditText et_teachersurname, et_teacherfirstname, et_teachercourse, et_teacherusername,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textview_login = (TextView) findViewById(R.id.teacher_login);
        ...
        et_teachercourse = (EditText) findViewById(R.id.et_teachercourse);
        ...
        et_teacherarrlist.add(et_teachercourse);
